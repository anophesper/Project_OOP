...
namespace Project.Organization
{
    public class Museum : IPresentable
    {
        ...
        public Museum(string name, string address, Owner owner, List<ArtObject>? artworks)
        {
            Name = name;
            Address = address;
            this.Owner = owner;
        ...
        {
            Console.WriteLine($"Museum: Name={Name}, Address={Address}, Owner={Owner.Name}, Number of Artworks ={ArtWorks?.Count ?? 0}");
        }

        //додавання нових арт об'єктів до вже існуючого об'єкта Museum
